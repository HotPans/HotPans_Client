...
function hotpansRouteConfig($stateProvider){
	...
	state('bakeryMenu', {
		url: "/bakeryMenu",
		controller: BakeryMenuController,
		templateUrl: "bakeryMenu.html"
	}).
	state('customerMenu', {
		url: "/customerMenu",
		controller: CustomerMenuController,
		templateUrl: "customerMenu.html"
	});
...
function StartController($scope, $location, $http) {
	...
	//goStartPageIfNotLogin($location, $http);
	initVariable();
}
...
function ConfirmCustomerInfoController($scope, $http, $location) {
	...
	$scope.registCustomer = function(customer){
		...
		//fd.append('phoneNumber1', customer.phoneNumber1);
		//fd.append('phoneNumber2', customer.phoneNumber2);
		//fd.append('introduction', customer.introduction);
...
//			fd.append('image', 'data:image/png;base64,');
//		}else{
//			fd.append('image', customer.image);
//		}
...
function BakeryMenuController($location, $http) {
	goStartPageIfNotLogin($location, $http);
}

function CustomerMenuController($location, $http) {
	goStartPageIfNotLogin($location, $http);
}
...
//		fd.append('password', $scope.login.password);
		...
		$http({
			...
			if(data.tokenForCertification != 'NG'){
				...
				$location.path("/administratorMenu");
			}else{
				// ログイン失敗の場合
				console.log("★ログイン失敗");
				$scope.login.message = "IDまたはパスワードが違います";
...
function goStartPageIfNotLogin($location, $http){
	//$location.path("/login");
	console.log("★goStartPageIfNotLogin");
	...
	var bakeryData = false;
	var customerData = false;
	...
	if(bakeryData == false && customerData == false){
		$location.path("/");
		//$route.reload();
	}
